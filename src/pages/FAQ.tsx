      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-6 py-3 bg-secondary text-secondary-foreground rounded-lg font-medium hover:bg-secondary/90 transition-colors glow-cyan">
              Join Telegram
            </button>
            <button className="px-6 py-3 bg-accent text-accent-foreground rounded-lg font-medium hover:bg-accent/90 transition-colors">
              Discord Server
            </button>
            <button className="px-6 py-3 bg-card border border-border rounded-lg font-medium hover:border-primary transition-colors">
              Contact Support
            </button>
          </div>
        </div>
